...
#ifndef GASSETS_ASSETS_MANAGER_HPP
#define GASSETS_ASSETS_MANAGER_HPP
...
constexpr char DEFAULT_MODEL_ID[] = "default";
...
namespace gassets {
    ...
    public:
        ...
        static GAPI void LoadTextureCubemap(const str& name, const str& filename, CubemapTextureLayout layout,
                                            i32 sceneId);
...
#endif //GASSETS_ASSETS_MANAGER_HPP
