...
void SceneGame::Load() {
    ...
    shaderTexture = AssetsManager::GenerateTexture(1280, 720, BLANK);
}
...
void SceneGame::Draw() {
    ...
    gdraw::SetShaderVec2("shader", "resolution", Vec2(1280, 720));

    gdraw::DrawTexture(shaderTexture, 0, 0, WHITE);
    gdraw::EndShaderMode();
}
